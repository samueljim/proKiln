(function () {
  ...
  describe('Admin Settingss List Controller Tests', function () {
    // Initialize global variables
    var SettingssAdminListController,
      $scope,
      $httpBackend,
      $state,
      Authentication,
    ...
    beforeEach(inject(function ($controller, $rootScope, _$state_, _$httpBackend_, _Authentication_, _SettingssService_) {
      ...
      $httpBackend.whenGET('/modules/settingss/client/views/list-settingss.client.view.html').respond(200, '');
      ...
      SettingssAdminListController = $controller('SettingssAdminListController as vm', {
        $scope: $scope
      });
